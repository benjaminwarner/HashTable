 ...
 * Tests for Change Scenario: ('G', 6) -> remove('G', 6) -> empty hash table 
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_10d_G6_removeG6_emptyHashTable_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.G6.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.G6.getKey(); 
