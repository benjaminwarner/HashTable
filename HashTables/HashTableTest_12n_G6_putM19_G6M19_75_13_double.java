...
public class HashTableTest_12n_G6_putM19_G6M19_75_13_double
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.G6.getKey(), 0, 6}, {TestCase.G6.getKey(), 1, 0}, 
			...
			{TestCase.M19.getKey(), 0, 6}, {TestCase.M19.getKey(), 1, 2}, 
			{TestCase.M19.getKey(), 2, 11}, {TestCase.M19.getKey(), 3, 7},{TestCase.M19.getKey(), 4, 3}, 
			{TestCase.M19.getKey(), 5, 12}, {TestCase.M19.getKey(), 6, 8},{TestCase.M19.getKey(), 7, 4}, 
			{TestCase.M19.getKey(), 8, 0},{TestCase.M19.getKey(), 9, 9}, {TestCase.M19.getKey(), 10, 5},
			{TestCase.M19.getKey(), 11, 1}, {TestCase.M19.getKey(), 12, 10}, {TestCase.M19.getKey(), 13, 6} }; 
