 ...
 * Tests for Change Scenario: ('F', 5) -> put('L', 18) -> ('F', 5), ('L', 18)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12m_F5_putL18_F5L18_75_13_double
{
	...
	private static final Character FIRST_VALUE = TestCase.F5.getValue(); 
	private static final int FIRST_KEY = TestCase.F5.getKey(); 
	private static final Character SECOND_VALUE = TestCase.L18.getValue(); 
	private static final int SECOND_KEY = TestCase.L18.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.F5.getValue(), TestCase.F5.getKey() }, 
			{TestCase.L18.getValue(), TestCase.L18.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.F5.getKey(), 0, 5}, {TestCase.F5.getKey(), 1, 11}, 
			{TestCase.F5.getKey(), 2, 4}, {TestCase.F5.getKey(), 3, 10},{TestCase.F5.getKey(), 4, 3}, 
			{TestCase.F5.getKey(), 5, 9}, {TestCase.F5.getKey(), 6, 2},{TestCase.F5.getKey(), 7, 8}, 
			{TestCase.F5.getKey(), 8, 1},{TestCase.F5.getKey(), 9, 7}, {TestCase.F5.getKey(), 10, 0},
			{TestCase.F5.getKey(), 11, 6}, {TestCase.F5.getKey(), 12, 12}, {TestCase.F5.getKey(), 13, 5}, 
			{TestCase.L18.getKey(), 0, 5}, {TestCase.L18.getKey(), 1, 0}, 
			{TestCase.L18.getKey(), 2, 8}, {TestCase.L18.getKey(), 3, 3},{TestCase.L18.getKey(), 4, 11}, 
			{TestCase.L18.getKey(), 5, 6}, {TestCase.L18.getKey(), 6, 1},{TestCase.L18.getKey(), 7, 9}, 
			{TestCase.L18.getKey(), 8, 4},{TestCase.L18.getKey(), 9, 12}, {TestCase.L18.getKey(), 10, 7},
			{TestCase.L18.getKey(), 11, 2}, {TestCase.L18.getKey(), 12, 10}, {TestCase.L18.getKey(), 13, 5} }; 
	// Valid value / key pairs with frequencies 
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.F5.getValue(), TestCase.F5.getKey(), 0}, 
			{TestCase.L18.getValue(), TestCase.L18.getKey(), 0} };	
