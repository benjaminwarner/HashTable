 ...
 * Tests for Change Scenario: ('I', 8) -> put('A', 21) -> ('I', 8), ('A', 21)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12p_I8_putA21_I8A21_75_13_double
{
	...
	private static final Character FIRST_VALUE = TestCase.I8.getValue(); 
	private static final int FIRST_KEY = TestCase.I8.getKey(); 
	private static final Character SECOND_VALUE = TestCase.A21.getValue(); 
	private static final int SECOND_KEY = TestCase.A21.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.I8.getValue(), TestCase.I8.getKey() }, 
			{TestCase.A21.getValue(), TestCase.A21.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.I8.getKey(), 0, 8}, {TestCase.I8.getKey(), 1, 4}, 
			{TestCase.I8.getKey(), 2, 0}, {TestCase.I8.getKey(), 3, 9},{TestCase.I8.getKey(), 4, 5}, 
			{TestCase.I8.getKey(), 5, 1}, {TestCase.I8.getKey(), 6, 10},{TestCase.I8.getKey(), 7, 6}, 
			{TestCase.I8.getKey(), 8, 2},{TestCase.I8.getKey(), 9, 11}, {TestCase.I8.getKey(), 10, 7},
			{TestCase.I8.getKey(), 11, 3}, {TestCase.I8.getKey(), 12, 12}, {TestCase.I8.getKey(), 13, 8}, 
			{TestCase.A21.getKey(), 0, 8}, {TestCase.A21.getKey(), 1, 6}, 
			{TestCase.A21.getKey(), 2, 4}, {TestCase.A21.getKey(), 3, 2},{TestCase.A21.getKey(), 4, 0}, 
			{TestCase.A21.getKey(), 5, 11}, {TestCase.A21.getKey(), 6, 9},{TestCase.A21.getKey(), 7, 7}, 
			{TestCase.A21.getKey(), 8, 5},{TestCase.A21.getKey(), 9, 3}, {TestCase.A21.getKey(), 10, 1},
			{TestCase.A21.getKey(), 11, 12}, {TestCase.A21.getKey(), 12, 10}, {TestCase.A21.getKey(), 13, 8} }; 
	// Valid value / key pairs with frequencies 
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.I8.getValue(), TestCase.I8.getKey(), 0}, 
			{TestCase.A21.getValue(), TestCase.A21.getKey(), 0} };	
