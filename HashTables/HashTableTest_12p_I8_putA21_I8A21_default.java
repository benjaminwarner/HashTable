...
public class HashTableTest_12p_I8_putA21_I8A21_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.I8.getKey(), 0, 8}, {TestCase.I8.getKey(), 1, 9}, 
			{TestCase.I8.getKey(), 2, 10}, {TestCase.I8.getKey(), 3, 11},{TestCase.I8.getKey(), 4, 12}, 
			{TestCase.I8.getKey(), 5, 0}, {TestCase.I8.getKey(), 6, 1},{TestCase.I8.getKey(), 7, 2}, 
			{TestCase.I8.getKey(), 8, 3},{TestCase.I8.getKey(), 9, 4}, {TestCase.I8.getKey(), 10, 5},
			{TestCase.I8.getKey(), 11, 6}, {TestCase.I8.getKey(), 12, 7}, {TestCase.I8.getKey(), 13, 8}, 
			{TestCase.A21.getKey(), 0, 8}, {TestCase.A21.getKey(), 1, 9}, 
			{TestCase.A21.getKey(), 2, 10}, {TestCase.A21.getKey(), 3, 11},{TestCase.A21.getKey(), 4, 12}, 
			{TestCase.A21.getKey(), 5, 0}, {TestCase.A21.getKey(), 6, 1},{TestCase.A21.getKey(), 7, 2}, 
			{TestCase.A21.getKey(), 8, 3},{TestCase.A21.getKey(), 9, 4}, {TestCase.A21.getKey(), 10, 5},
			{TestCase.A21.getKey(), 11, 6}, {TestCase.A21.getKey(), 12, 7}, {TestCase.A21.getKey(), 13, 8} }; 
