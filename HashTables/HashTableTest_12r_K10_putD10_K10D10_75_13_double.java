 ...
 * Tests for Change Scenario: ('K', 10) -> put('D', 10) -> ('K', 10), ('D', 10)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12r_K10_putD10_K10D10_75_13_double
{
	...
	private static final Character FIRST_VALUE = TestCase.K10.getValue(); 
	private static final int FIRST_KEY = TestCase.K10.getKey(); 
	private static final Character SECOND_VALUE = TestCase.D10.getValue(); 
	private static final int SECOND_KEY = TestCase.D10.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.K10.getValue(), TestCase.K10.getKey() }, 
			{TestCase.D10.getValue(), TestCase.D10.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.K10.getKey(), 0, 10}, {TestCase.K10.getKey(), 1, 8}, 
			{TestCase.K10.getKey(), 2, 6}, {TestCase.K10.getKey(), 3, 4},{TestCase.K10.getKey(), 4, 2}, 
			{TestCase.K10.getKey(), 5, 0}, {TestCase.K10.getKey(), 6, 11},{TestCase.K10.getKey(), 7, 9}, 
			{TestCase.K10.getKey(), 8, 7},{TestCase.K10.getKey(), 9, 5}, {TestCase.K10.getKey(), 10, 3},
			{TestCase.K10.getKey(), 11, 1}, {TestCase.K10.getKey(), 12, 12}, {TestCase.K10.getKey(), 13, 10}, 
			{TestCase.D10.getKey(), 0, 10}, {TestCase.D10.getKey(), 1, 8}, 
			{TestCase.D10.getKey(), 2, 6}, {TestCase.D10.getKey(), 3, 4},{TestCase.D10.getKey(), 4, 2}, 
			{TestCase.D10.getKey(), 5, 0}, {TestCase.D10.getKey(), 6, 11},{TestCase.D10.getKey(), 7, 9}, 
			{TestCase.D10.getKey(), 8, 7},{TestCase.D10.getKey(), 9, 5}, {TestCase.D10.getKey(), 10, 3},
			{TestCase.D10.getKey(), 11, 1}, {TestCase.D10.getKey(), 12, 12}, {TestCase.D10.getKey(), 13, 10} }; 
	// Valid value / key pairs with frequencies 
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.K10.getValue(), TestCase.K10.getKey(), 0}, 
			{TestCase.D10.getValue(), TestCase.D10.getKey(), 0} };	
