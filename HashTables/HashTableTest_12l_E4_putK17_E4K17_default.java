...
public class HashTableTest_12l_E4_putK17_E4K17_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.E4.getKey(), 0, 4}, {TestCase.E4.getKey(), 1, 5}, 
			...
			{TestCase.K17.getKey(), 0, 4}, {TestCase.K17.getKey(), 1, 5}, 
			{TestCase.K17.getKey(), 2, 6}, {TestCase.K17.getKey(), 3, 7},{TestCase.K17.getKey(), 4, 8}, 
			{TestCase.K17.getKey(), 5, 9}, {TestCase.K17.getKey(), 6, 10},{TestCase.K17.getKey(), 7, 11}, 
			{TestCase.K17.getKey(), 8, 12},{TestCase.K17.getKey(), 9, 0}, {TestCase.K17.getKey(), 10, 1},
			{TestCase.K17.getKey(), 11, 2}, {TestCase.K17.getKey(), 12, 3}, {TestCase.K17.getKey(), 13, 4} }; 
