 ...
 * Tests for Change Scenario: ('J', 9) -> put('B', 22) -> ('J', 9), ('B', 22)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12q_J9_putB22_J9B22_75_13_double
{
	...
	private static final Character FIRST_VALUE = TestCase.J9.getValue(); 
	private static final int FIRST_KEY = TestCase.J9.getKey(); 
	private static final Character SECOND_VALUE = TestCase.B22.getValue(); 
	private static final int SECOND_KEY = TestCase.B22.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.J9.getValue(), TestCase.J9.getKey() }, 
			{TestCase.B22.getValue(), TestCase.B22.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.J9.getKey(), 0, 9}, {TestCase.J9.getKey(), 1, 6}, 
			{TestCase.J9.getKey(), 2, 3}, {TestCase.J9.getKey(), 3, 0},{TestCase.J9.getKey(), 4, 10}, 
			{TestCase.J9.getKey(), 5, 7}, {TestCase.J9.getKey(), 6, 4},{TestCase.J9.getKey(), 7, 1}, 
			{TestCase.J9.getKey(), 8, 11},{TestCase.J9.getKey(), 9, 8}, {TestCase.J9.getKey(), 10, 5},
			{TestCase.J9.getKey(), 11, 2}, {TestCase.J9.getKey(), 12, 12}, {TestCase.J9.getKey(), 13, 9}, 
			{TestCase.B22.getKey(), 0, 9}, {TestCase.B22.getKey(), 1, 10}, 
			{TestCase.B22.getKey(), 2, 11}, {TestCase.B22.getKey(), 3, 12},{TestCase.B22.getKey(), 4, 0}, 
			{TestCase.B22.getKey(), 5, 1}, {TestCase.B22.getKey(), 6, 2},{TestCase.B22.getKey(), 7, 3}, 
			{TestCase.B22.getKey(), 8, 4},{TestCase.B22.getKey(), 9, 5}, {TestCase.B22.getKey(), 10, 6},
			{TestCase.B22.getKey(), 11, 7}, {TestCase.B22.getKey(), 12, 8}, {TestCase.B22.getKey(), 13, 9} }; 
	// Valid value / key pairs with frequencies 
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.J9.getValue(), TestCase.J9.getKey(), 0}, 
			{TestCase.B22.getValue(), TestCase.B22.getKey(), 0} };	
