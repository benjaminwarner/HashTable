...
public class HashTableTest_12k_D3_putJ16_D3J16_75_13_double
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.D3.getKey(), 0, 3}, {TestCase.D3.getKey(), 1, 7}, 
			...
			{TestCase.J16.getKey(), 0, 3}, {TestCase.J16.getKey(), 1, 9}, 
			{TestCase.J16.getKey(), 2, 2}, {TestCase.J16.getKey(), 3, 8},{TestCase.J16.getKey(), 4, 1}, 
			{TestCase.J16.getKey(), 5, 7}, {TestCase.J16.getKey(), 6, 0},{TestCase.J16.getKey(), 7, 6}, 
			{TestCase.J16.getKey(), 8, 12},{TestCase.J16.getKey(), 9, 5}, {TestCase.J16.getKey(), 10, 11},
			{TestCase.J16.getKey(), 11, 4}, {TestCase.J16.getKey(), 12, 10}, {TestCase.J16.getKey(), 13, 3} }; 
