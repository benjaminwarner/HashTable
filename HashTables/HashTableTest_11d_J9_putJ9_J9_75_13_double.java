 ...
 * Tests for Change Scenario: ('J', 9) -> put('J', 9) -> ('J', 9)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_11d_J9_putJ9_J9_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.J9.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.J9.getKey(); 
	// Hash of valid value with default parameters and 0 prior attempts  
	private static final int EXPECTED_HASH = 9; 
