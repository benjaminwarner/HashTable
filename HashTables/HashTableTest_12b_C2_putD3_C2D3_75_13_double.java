 ...
 * Tests for Change Scenario: ('C', 2) -> put('D', 3) -> ('C', 2), ('D', 3)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12b_C2_putD3_C2D3_75_13_double
{
	...
	private static final Character SECOND_VALUE = TestCase.D3.getValue(); 
	private static final int SECOND_KEY = TestCase.D3.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.C2.getValue(), TestCase.C2.getKey() }, 
			{TestCase.D3.getValue(), TestCase.D3.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.C2.getKey(), 0, 2}, {TestCase.C2.getKey(), 1, 5}, 
			{TestCase.C2.getKey(), 2, 8}, {TestCase.C2.getKey(), 3, 11},{TestCase.C2.getKey(), 4, 1}, 
			{TestCase.C2.getKey(), 5, 4}, {TestCase.C2.getKey(), 6, 7},{TestCase.C2.getKey(), 7, 10}, 
			{TestCase.C2.getKey(), 8, 0},{TestCase.C2.getKey(), 9, 3}, {TestCase.C2.getKey(), 10, 6},
			{TestCase.C2.getKey(), 11, 9}, {TestCase.C2.getKey(), 12, 12}, {TestCase.C2.getKey(), 13, 2}, 
			{TestCase.D3.getKey(), 0, 3}, {TestCase.D3.getKey(), 1, 7}, 
			{TestCase.D3.getKey(), 2, 11}, {TestCase.D3.getKey(), 3, 2},{TestCase.D3.getKey(), 4, 6}, 
			{TestCase.D3.getKey(), 5, 10}, {TestCase.D3.getKey(), 6, 1},{TestCase.D3.getKey(), 7, 5}, 
			{TestCase.D3.getKey(), 8, 9},{TestCase.D3.getKey(), 9, 0}, {TestCase.D3.getKey(), 10, 4},
			{TestCase.D3.getKey(), 11, 8}, {TestCase.D3.getKey(), 12, 12}, {TestCase.D3.getKey(), 13, 3} }; 
	...
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.C2.getValue(), TestCase.C2.getKey(), 0}, 
			{TestCase.D3.getValue(), TestCase.D3.getKey(), 0} };	
