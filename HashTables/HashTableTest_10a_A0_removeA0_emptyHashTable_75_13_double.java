 ...
 * Tests for Change Scenario: ('A', 0) -> remove('A', 0) -> empty hash table 
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_10a_A0_removeA0_emptyHashTable_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.A0.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.A0.getKey(); 
