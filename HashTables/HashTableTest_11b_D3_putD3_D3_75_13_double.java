 ...
 * Tests for Change Scenario: ('D', 3) -> put('D', 3) -> ('D', 3)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_11b_D3_putD3_D3_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.D3.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.D3.getKey(); 
	// Hash of valid value with default parameters and 0 prior attempts  
	private static final int EXPECTED_HASH = 3; 
