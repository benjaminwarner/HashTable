 ...
 * Tests for Change Scenario: ('C', 2) -> remove('C', 2) -> empty hash table 
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_10b_C2_removeC2_emptyHashTable_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.C2.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.C2.getKey(); 
