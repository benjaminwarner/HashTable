 ...
 * Tests for Change Scenario: ('I', 8) -> put('J', 9) -> ('I', 8), ('J', 9)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12e_I8_putJ9_I8J9_75_13_double
{
	...
	private static final Character SECOND_VALUE = TestCase.J9.getValue(); 
	private static final int SECOND_KEY = TestCase.J9.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.I8.getValue(), TestCase.I8.getKey() }, 
			{TestCase.J9.getValue(), TestCase.J9.getKey()} };
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.I8.getKey(), 0, 8}, {TestCase.I8.getKey(), 1, 4}, 
			...
			{TestCase.J9.getKey(), 0, 9}, {TestCase.J9.getKey(), 1, 6}, 
	...
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.I8.getValue(), TestCase.I8.getKey(), 0}, 
			{TestCase.J9.getValue(), TestCase.J9.getKey(), 0} };	
