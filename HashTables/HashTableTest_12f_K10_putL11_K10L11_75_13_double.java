 ...
 * Tests for Change Scenario: ('K', 10) -> put('L', 11) -> ('K', 10), ('L', 11)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12f_K10_putL11_K10L11_75_13_double
{
	...
	private static final Character SECOND_VALUE = TestCase.L11.getValue(); 
	private static final int SECOND_KEY = TestCase.L11.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.K10.getValue(), TestCase.K10.getKey() }, 
			{TestCase.L11.getValue(), TestCase.L11.getKey()} };
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.K10.getKey(), 0, 10}, {TestCase.K10.getKey(), 1, 8}, 
			...
			{TestCase.L11.getKey(), 0, 11}, {TestCase.L11.getKey(), 1, 12}, 
