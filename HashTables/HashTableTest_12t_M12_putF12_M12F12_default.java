...
public class HashTableTest_12t_M12_putF12_M12F12_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.M12.getKey(), 0, 12}, {TestCase.M12.getKey(), 1, 0}, 
			...
			{TestCase.F12.getKey(), 0, 12}, {TestCase.F12.getKey(), 1, 0}, 
			{TestCase.F12.getKey(), 2, 1}, {TestCase.F12.getKey(), 3, 2},{TestCase.F12.getKey(), 4, 3}, 
			{TestCase.F12.getKey(), 5, 4}, {TestCase.F12.getKey(), 6, 5},{TestCase.F12.getKey(), 7, 6}, 
			{TestCase.F12.getKey(), 8, 7},{TestCase.F12.getKey(), 9, 8}, {TestCase.F12.getKey(), 10, 9},
			{TestCase.F12.getKey(), 11, 10}, {TestCase.F12.getKey(), 12, 11}, {TestCase.F12.getKey(), 13, 12} }; 
