...
public class HashTableTest_12i_B1_putH14_B1H14_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.B1.getKey(), 0, 1}, {TestCase.B1.getKey(), 1, 2}, 
			{TestCase.B1.getKey(), 2, 3}, {TestCase.B1.getKey(), 3, 4},{TestCase.B1.getKey(), 4, 5}, 
			{TestCase.B1.getKey(), 5, 6}, {TestCase.B1.getKey(), 6, 7},{TestCase.B1.getKey(), 7, 8}, 
			{TestCase.B1.getKey(), 8, 9},{TestCase.B1.getKey(), 9, 10}, {TestCase.B1.getKey(), 10, 11},
			{TestCase.B1.getKey(), 11, 12}, {TestCase.B1.getKey(), 12, 0}, {TestCase.B1.getKey(), 13, 1}, 
			{TestCase.H14.getKey(), 0, 1}, {TestCase.H14.getKey(), 1, 2}, 
			{TestCase.H14.getKey(), 2, 3}, {TestCase.H14.getKey(), 3, 4},{TestCase.H14.getKey(), 4, 5}, 
			{TestCase.H14.getKey(), 5, 6}, {TestCase.H14.getKey(), 6, 7},{TestCase.H14.getKey(), 7, 8}, 
			{TestCase.H14.getKey(), 8, 9},{TestCase.H14.getKey(), 9, 10}, {TestCase.H14.getKey(), 10, 11},
			{TestCase.H14.getKey(), 11, 12}, {TestCase.H14.getKey(), 12, 0}, {TestCase.H14.getKey(), 13, 1} }; 
