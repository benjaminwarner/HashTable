...
public class HashTableTest_12r_K10_putD10_K10D10_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.K10.getKey(), 0, 10}, {TestCase.K10.getKey(), 1, 11}, 
			{TestCase.K10.getKey(), 2, 12}, {TestCase.K10.getKey(), 3, 0},{TestCase.K10.getKey(), 4, 1}, 
			{TestCase.K10.getKey(), 5, 2}, {TestCase.K10.getKey(), 6, 3},{TestCase.K10.getKey(), 7, 4}, 
			{TestCase.K10.getKey(), 8, 5},{TestCase.K10.getKey(), 9, 6}, {TestCase.K10.getKey(), 10, 7},
			{TestCase.K10.getKey(), 11, 8}, {TestCase.K10.getKey(), 12, 9}, {TestCase.K10.getKey(), 13, 10}, 
			{TestCase.D10.getKey(), 0, 10}, {TestCase.D10.getKey(), 1, 11}, 
			{TestCase.D10.getKey(), 2, 12}, {TestCase.D10.getKey(), 3, 0},{TestCase.D10.getKey(), 4, 1}, 
			{TestCase.D10.getKey(), 5, 2}, {TestCase.D10.getKey(), 6, 3},{TestCase.D10.getKey(), 7, 4}, 
			{TestCase.D10.getKey(), 8, 5},{TestCase.D10.getKey(), 9, 6}, {TestCase.D10.getKey(), 10, 7},
			{TestCase.D10.getKey(), 11, 8}, {TestCase.D10.getKey(), 12, 9}, {TestCase.D10.getKey(), 13, 10} }; 
