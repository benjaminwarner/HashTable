 ...
 * Tests for Change Scenario: ('N', 13) -> put('G', 13) -> ('N', 13), ('G', 13)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12u_N13_putFG13_N13G13_75_13_double
{
	...
	private static final Character FIRST_VALUE = TestCase.N13.getValue(); 
	private static final int FIRST_KEY = TestCase.N13.getKey(); 
	private static final Character SECOND_VALUE = TestCase.G13.getValue(); 
	private static final int SECOND_KEY = TestCase.G13.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.N13.getValue(), TestCase.N13.getKey() }, 
			{TestCase.G13.getValue(), TestCase.G13.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.N13.getKey(), 0, 0}, {TestCase.N13.getKey(), 1, 3}, 
			{TestCase.N13.getKey(), 2, 6}, {TestCase.N13.getKey(), 3, 9},{TestCase.N13.getKey(), 4, 12}, 
			{TestCase.N13.getKey(), 5, 2}, {TestCase.N13.getKey(), 6, 5},{TestCase.N13.getKey(), 7, 8}, 
			{TestCase.N13.getKey(), 8, 11},{TestCase.N13.getKey(), 9, 1}, {TestCase.N13.getKey(), 10, 4},
			{TestCase.N13.getKey(), 11, 7}, {TestCase.N13.getKey(), 12, 10}, {TestCase.N13.getKey(), 13, 0}, 
			{TestCase.G13.getKey(), 0, 0}, {TestCase.G13.getKey(), 1, 3}, 
			{TestCase.G13.getKey(), 2, 6}, {TestCase.G13.getKey(), 3, 9},{TestCase.G13.getKey(), 4, 12}, 
			{TestCase.G13.getKey(), 5, 2}, {TestCase.G13.getKey(), 6, 5},{TestCase.G13.getKey(), 7, 8}, 
			{TestCase.G13.getKey(), 8, 11},{TestCase.G13.getKey(), 9, 1}, {TestCase.G13.getKey(), 10, 4},
			{TestCase.G13.getKey(), 11, 7}, {TestCase.G13.getKey(), 12, 10}, {TestCase.G13.getKey(), 13, 0} }; 
	// Valid value / key pairs with frequencies 
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.N13.getValue(), TestCase.N13.getKey(), 0}, 
			{TestCase.G13.getValue(), TestCase.G13.getKey(), 0} };	
