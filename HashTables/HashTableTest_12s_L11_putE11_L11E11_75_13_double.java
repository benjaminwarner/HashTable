 ...
 * Tests for Change Scenario: ('L', 11) -> put('E', 11) -> ('L', 11), ('E', 11)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12s_L11_putE11_L11E11_75_13_double
{
	...
	private static final Character SECOND_VALUE = TestCase.E11.getValue(); 
	private static final int SECOND_KEY = TestCase.E11.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.L11.getValue(), TestCase.L11.getKey() }, 
			{TestCase.E11.getValue(), TestCase.E11.getKey()} };
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.L11.getKey(), 0, 11}, {TestCase.L11.getKey(), 1, 12}, 
			...
			{TestCase.E11.getKey(), 0, 11}, {TestCase.E11.getKey(), 1, 12}, 
			{TestCase.E11.getKey(), 2, 0}, {TestCase.E11.getKey(), 3, 1},{TestCase.E11.getKey(), 4, 2}, 
			{TestCase.E11.getKey(), 5, 3}, {TestCase.E11.getKey(), 6, 4},{TestCase.E11.getKey(), 7, 5}, 
			{TestCase.E11.getKey(), 8, 6},{TestCase.E11.getKey(), 9, 7}, {TestCase.E11.getKey(), 10, 8},
			{TestCase.E11.getKey(), 11, 9}, {TestCase.E11.getKey(), 12, 10}, {TestCase.E11.getKey(), 13, 11} }; 
	...
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.L11.getValue(), TestCase.L11.getKey(), 0}, 
			{TestCase.E11.getValue(), TestCase.E11.getKey(), 0} };	
