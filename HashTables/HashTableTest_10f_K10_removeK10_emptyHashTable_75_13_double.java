 ...
 * Tests for Change Scenario: ('K', 10) -> remove('K', 10) -> empty hash table 
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_10f_K10_removeK10_emptyHashTable_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.K10.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.K10.getKey(); 
