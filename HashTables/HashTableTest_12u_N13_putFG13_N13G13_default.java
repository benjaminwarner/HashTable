...
public class HashTableTest_12u_N13_putFG13_N13G13_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.N13.getKey(), 0, 0}, {TestCase.N13.getKey(), 1, 1}, 
			{TestCase.N13.getKey(), 2, 2}, {TestCase.N13.getKey(), 3, 3},{TestCase.N13.getKey(), 4, 4}, 
			{TestCase.N13.getKey(), 5, 5}, {TestCase.N13.getKey(), 6, 6},{TestCase.N13.getKey(), 7, 7}, 
			{TestCase.N13.getKey(), 8, 8},{TestCase.N13.getKey(), 9, 9}, {TestCase.N13.getKey(), 10, 10},
			{TestCase.N13.getKey(), 11, 11}, {TestCase.N13.getKey(), 12, 12}, {TestCase.N13.getKey(), 13, 0}, 
			{TestCase.G13.getKey(), 0, 0}, {TestCase.G13.getKey(), 1, 1}, 
			{TestCase.G13.getKey(), 2, 2}, {TestCase.G13.getKey(), 3, 3},{TestCase.G13.getKey(), 4, 4}, 
			{TestCase.G13.getKey(), 5, 5}, {TestCase.G13.getKey(), 6, 6},{TestCase.G13.getKey(), 7, 7}, 
			{TestCase.G13.getKey(), 8, 8},{TestCase.G13.getKey(), 9, 9}, {TestCase.G13.getKey(), 10, 10},
			{TestCase.G13.getKey(), 11, 11}, {TestCase.G13.getKey(), 12, 12}, {TestCase.G13.getKey(), 13, 0} }; 
