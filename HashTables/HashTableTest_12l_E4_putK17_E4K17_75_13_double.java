 ...
 * Tests for Change Scenario: ('E', 4) -> put('K', 17) -> ('E', 4), ('K', 17)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_12l_E4_putK17_E4K17_75_13_double
{
	...
	private static final Character SECOND_VALUE = TestCase.K17.getValue(); 
	private static final int SECOND_KEY = TestCase.K17.getKey(); 
	// Valid value / key pairs 
	private static final Object[][] VALID_VALUES_KEYS = { {TestCase.E4.getValue(), TestCase.E4.getKey() }, 
			{TestCase.K17.getValue(), TestCase.K17.getKey()} };
	// Expected hashes for given keys and attempts 
	private static final Object[][] EXPECTED_HASHES = { {TestCase.E4.getKey(), 0, 4}, {TestCase.E4.getKey(), 1, 9}, 
			{TestCase.E4.getKey(), 2, 1}, {TestCase.E4.getKey(), 3, 6},{TestCase.E4.getKey(), 4, 11}, 
			{TestCase.E4.getKey(), 5, 3}, {TestCase.E4.getKey(), 6, 8},{TestCase.E4.getKey(), 7, 0}, 
			{TestCase.E4.getKey(), 8, 5},{TestCase.E4.getKey(), 9, 10}, {TestCase.E4.getKey(), 10, 2},
			{TestCase.E4.getKey(), 11, 7}, {TestCase.E4.getKey(), 12, 12}, {TestCase.E4.getKey(), 13, 4}, 
			{TestCase.K17.getKey(), 0, 4}, {TestCase.K17.getKey(), 1, 11}, 
			{TestCase.K17.getKey(), 2, 5}, {TestCase.K17.getKey(), 3, 12},{TestCase.K17.getKey(), 4, 6}, 
			{TestCase.K17.getKey(), 5, 0}, {TestCase.K17.getKey(), 6, 7},{TestCase.K17.getKey(), 7, 1}, 
			{TestCase.K17.getKey(), 8, 8},{TestCase.K17.getKey(), 9, 2}, {TestCase.K17.getKey(), 10, 9},
			{TestCase.K17.getKey(), 11, 3}, {TestCase.K17.getKey(), 12, 10}, {TestCase.K17.getKey(), 13, 4} }; 
	...
	private static final Object[][] VALID_FREQUENCIES = { {TestCase.E4.getValue(), TestCase.E4.getKey(), 0}, 
			{TestCase.K17.getValue(), TestCase.K17.getKey(), 0} };	
