 ...
 * Tests for Change Scenario: ('E', 4) -> remove('E', 4) -> empty hash table 
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_10c_E4_removeE4_emptyHashTable_75_13_double
{
	...
	private static final Character VALID_VALUE = TestCase.E4.getValue(); 
	// Key of value adding to table 
	private static final int VALID_KEY = TestCase.E4.getKey(); 
