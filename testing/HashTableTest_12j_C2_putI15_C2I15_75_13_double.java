...
public class HashTableTest_12j_C2_putI15_C2I15_75_13_double
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.C2.getKey(), 0, 2}, {TestCase.C2.getKey(), 1, 5}, 
			...
			{TestCase.I15.getKey(), 0, 2}, {TestCase.I15.getKey(), 1, 7}, 
			{TestCase.I15.getKey(), 2, 12}, {TestCase.I15.getKey(), 3, 4},{TestCase.I15.getKey(), 4, 9}, 
			{TestCase.I15.getKey(), 5, 1}, {TestCase.I15.getKey(), 6, 6},{TestCase.I15.getKey(), 7, 11}, 
			{TestCase.I15.getKey(), 8, 3},{TestCase.I15.getKey(), 9, 8}, {TestCase.I15.getKey(), 10, 0},
			{TestCase.I15.getKey(), 11, 5}, {TestCase.I15.getKey(), 12, 10}, {TestCase.I15.getKey(), 13, 2} }; 
