...
public class HashTableTest_12o_H7_putN20_H7N20_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.H7.getKey(), 0, 7}, {TestCase.H7.getKey(), 1, 8}, 
			{TestCase.H7.getKey(), 2, 9}, {TestCase.H7.getKey(), 3, 10},{TestCase.H7.getKey(), 4, 11}, 
			{TestCase.H7.getKey(), 5, 12}, {TestCase.H7.getKey(), 6, 0},{TestCase.H7.getKey(), 7, 1}, 
			{TestCase.H7.getKey(), 8, 2},{TestCase.H7.getKey(), 9, 3}, {TestCase.H7.getKey(), 10, 4},
			{TestCase.H7.getKey(), 11, 5}, {TestCase.H7.getKey(), 12, 6}, {TestCase.H7.getKey(), 13, 7}, 
			{TestCase.N20.getKey(), 0, 7}, {TestCase.N20.getKey(), 1, 8}, 
			{TestCase.N20.getKey(), 2, 9}, {TestCase.N20.getKey(), 3, 10},{TestCase.N20.getKey(), 4, 11}, 
			{TestCase.N20.getKey(), 5, 12}, {TestCase.N20.getKey(), 6, 0},{TestCase.N20.getKey(), 7, 1}, 
			{TestCase.N20.getKey(), 8, 2},{TestCase.N20.getKey(), 9, 3}, {TestCase.N20.getKey(), 10, 4},
			{TestCase.N20.getKey(), 11, 5}, {TestCase.N20.getKey(), 12, 6}, {TestCase.N20.getKey(), 13, 7} }; 
