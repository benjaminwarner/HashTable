 ...
 * Tests for Change Scenario: ('A', 0) -> put('A', 0) -> ('A', 0)
 * with alpha = 0.75, capacity = 13, using double hashing.  
 * @author CS 321
 */

public class HashTableTest_11a_A0_putA0_A0_75_13_double
{
	...
	private static final int EXPECTED_HASH = 0; 
	...
	private static final int EXPECTED_NUM_DUPLICATES = 1; 
