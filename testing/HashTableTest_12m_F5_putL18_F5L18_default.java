...
public class HashTableTest_12m_F5_putL18_F5L18_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.F5.getKey(), 0, 5}, {TestCase.F5.getKey(), 1, 6}, 
			...
			{TestCase.L18.getKey(), 0, 5}, {TestCase.L18.getKey(), 1, 6}, 
			{TestCase.L18.getKey(), 2, 7}, {TestCase.L18.getKey(), 3, 8},{TestCase.L18.getKey(), 4, 9}, 
			{TestCase.L18.getKey(), 5, 10}, {TestCase.L18.getKey(), 6, 11},{TestCase.L18.getKey(), 7, 12}, 
			{TestCase.L18.getKey(), 8, 0},{TestCase.L18.getKey(), 9, 1}, {TestCase.L18.getKey(), 10, 2},
			{TestCase.L18.getKey(), 11, 3}, {TestCase.L18.getKey(), 12, 4}, {TestCase.L18.getKey(), 13, 5} }; 
