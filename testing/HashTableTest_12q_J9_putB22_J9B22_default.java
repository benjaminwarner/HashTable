...
public class HashTableTest_12q_J9_putB22_J9B22_default
{
	...
	private static final Object[][] EXPECTED_HASHES = { {TestCase.J9.getKey(), 0, 9}, {TestCase.J9.getKey(), 1, 10}, 
			{TestCase.J9.getKey(), 2, 11}, {TestCase.J9.getKey(), 3, 12},{TestCase.J9.getKey(), 4, 0}, 
			{TestCase.J9.getKey(), 5, 1}, {TestCase.J9.getKey(), 6, 2},{TestCase.J9.getKey(), 7, 3}, 
			{TestCase.J9.getKey(), 8, 4},{TestCase.J9.getKey(), 9, 5}, {TestCase.J9.getKey(), 10, 6},
			{TestCase.J9.getKey(), 11, 7}, {TestCase.J9.getKey(), 12, 8}, {TestCase.J9.getKey(), 13, 9}, 
